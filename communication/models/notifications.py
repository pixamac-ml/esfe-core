...
class CommunicationNotification(models.Model):
    ...
    actor = models.ForeignKey(
        ...
        blank=True,
        on_delete=models.SET_NULL,
        related_name="communication_notifications_sent",
    )
...
class CommunicationDelivery(models.Model):
    ...
    channel = models.CharField(max_length=30, choices=CommunicationNotification.CHANNEL_CHOICES)
    provider = models.CharField(max_length=50, blank=True)
    status = models.CharField(
        max_length=20,
        choices=CommunicationNotification.STATUS_CHOICES,
        default=CommunicationNotification.STATUS_PENDING,
    )
