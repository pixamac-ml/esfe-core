...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("portal", "0020_academic_enrollment_movements"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("staff_assigned", "Affectation staff modifiee"),
                    ("manager_nominated", "Gestionnaire d'annexe nomme"),
                    ...
                    ("reenrollment_proposed", "Passage propose"),
                    ("reenrollment_validated", "Passage valide"),
                    ("reenrollment_applied", "Passage applique"),
                    ("reenrollment_rejected", "Passage rejete"),
                ],
                db_index=True,
                max_length=30,
            ),
